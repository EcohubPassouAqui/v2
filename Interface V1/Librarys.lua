...
local function MkSecObj(scroll)
	...
	function obj:AddSlider(text, minV, maxV, defV, callback)
		return MkSlider(scroll, text, minV, maxV, defV, callback)
	end
	function obj:AddDropdown(text, opts, defV, callback)
		return MkDropdown(scroll, text, opts, defV, callback)
	end
	function obj:AddKeybind(text, defKey, callback)
		return MkKeybind(scroll, text, defKey, callback)
	end
	function obj:AddColorPicker(text, defCol, callback)
		return MkColorPicker(scroll, text, defCol, callback)
	end
