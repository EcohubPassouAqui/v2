		...
		function tab:AddSection(cfg2)
			...
			function sec:AddButton(cfg3)
				...
				local indicator = ni("Frame", {
					...
					BackgroundColor3 = Theme.accentHi, BorderSizePixel = 0, ZIndex = 5,
				}, row)
				corner(indicator, 3)
				...
				btn.MouseEnter:Connect(function() tw(row, {BackgroundColor3=Theme.elemHover}, 0.12) end)
				btn.MouseLeave:Connect(function() tw(row, {BackgroundColor3=Theme.elemBg},   0.12) end)
